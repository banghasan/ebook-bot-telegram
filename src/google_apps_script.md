...
| Metadata | Detail |
| :--- | :--- |
| **Penulis (Author)** | Manus AI |
| **Email** | help@manus.im |
| **Diskusi (Discussion)** | https://help.manus.im |
...
[1] Lumpia Framework. *Dokumentasi Resmi Lumpia Framework*. https://lumpia.js.org/
[2] telegrambotindonesia. *GAS-Lib-v3*. GitHub. https://github.com/telegrambotindonesia/GAS-Lib-v3
[3] Telegram. *Bot API*. https://core.telegram.org/bots/api
[4] Telegram Bot Indonesia. *Grup Diskusi Telegram*. t.me/botIndonesia
